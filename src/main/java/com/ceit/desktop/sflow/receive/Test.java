...
import com.ceit.desktop.sflow.utils.DataConvert;
import com.ceit.desktop.sflow.utils.IpOperation;
import com.ceit.desktop.sflow.utils.TimeUtils;
...
public class Test {
	public static void main(String[] args) throws IOException {
		SflowProcess sflowProcess = new SflowProcess();
		sflowProcess.init(6343);
		sflowProcess.SflowProcessStart();
	}
